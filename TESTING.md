# Offside CRM — End-to-End Test Cases (TESTING.md)

> User-perspective end-to-end test scenarios. Each case is written as steps a real user would perform, not as a unit test. IDs are stable (`TC-N`); cross-references to [PRD.md](./PRD.md) functional requirements are noted as `FR-N`.
