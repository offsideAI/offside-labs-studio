      ...
      <section className="bg-black py-24 relative overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold">Whatever your workflow,<br />it runs on OffsideStudio.</h2>
          </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="pt-4 max-w-[280px]">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <button className="bg-render-green hover:bg-[#34d399] text-black font-semibold rounded-sm px-4 py-2 text-sm transition-colors self-start w-fit">
                    Subscribe
                  </button>
                </div>
              </div>
